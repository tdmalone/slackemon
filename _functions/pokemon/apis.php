...
function slackemon_get_pokemon_data( $pokedex_number ) {
  ...
  $pokemon_data = json_decode( get_cached_url( $pokemon_url ) );
...
function slackemon_get_pokemon_species_data( $pokedex_number ) {
  ...
  $species_data = json_decode( get_cached_url( $species_url ) );
...
function slackemon_get_pokemon_growth_rate_data( $pokedex_number ) {
  ...
  $species_data = slackemon_get_pokemon_species_data( $pokedex_number );
  $growth_rate_data = json_decode( get_cached_url( $species_data->growth_rate->url ) );
...
function slackemon_get_move_data( $move_name_or_id ) {
  ...
  $move_data = json_decode( get_cached_url( 'http://pokeapi.co/api/v2/move/' . $move_name_or_id . '/' ) );
...
function slackemon_get_supplementary_move_data() {
  ...
  $supplementary_move_filename = __DIR__ . '/../../slackemon/supplementary-data/moves.json';
...
function slackemon_get_item_data( $item_name_or_id ) {
  ...
  $item_data = json_decode( get_cached_url( 'http://pokeapi.co/api/v2/item/' . $item_name_or_id . '/' ) );
...
function slackemon_get_supplementary_item_data() {
  ...
  $supplementary_item_filename = __DIR__ . '/../../slackemon/supplementary-data/items.json';
