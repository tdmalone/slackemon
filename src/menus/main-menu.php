...
function slackemon_get_latest_news() {
  ...
  $latest_news = [
    ':trophy: Level limited battles have arrived: train against players of any level!',
    ':card_index_dividers: You can now filter your Pokémon by level in the Pokémon menu.',
  ];
